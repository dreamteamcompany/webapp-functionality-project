...
export class AdminSimulator {
  ...
  private buildFirstCallTree(): Map<number, DialogueChoice[]> {
    ...
    tree.set(0, [
      ...
      {
        id: 201,
        text: 'Здравствуйте! Клиника "Жемчужина", чем могу помочь?',
        type: 'neutral',
      ...
      {
        id: 202,
        text: 'Клиника "Жемчужина", добрый день! Я Анна, с удовольствием помогу вам записаться. Что именно беспокоит?',
        type: 'good',
