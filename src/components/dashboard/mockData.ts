...
export const mockKnowledgeBase = [
  {
    id: 'procedures',
    name: 'Процедуры и протоколы',
    description: 'Стандарты работы и клинические протоколы',
    icon: 'FileText',
    lastUpdated: '15.01.2024',
    articles: [
      {
        id: 1,
        title: 'Протокол первичной консультации',
        content: 'Подробное описание этапов первичной консультации пациента. Включает сбор анамнеза, осмотр, диагностику и составление плана лечения.',
        tags: ['консультация', 'протокол', 'прием'],
        updatedAt: '15.01.2024',
        views: 245
      },
      {
        id: 2,
        title: 'Стандарт работы с имплантами',
        content: 'Пошаговая инструкция по планированию и установке дентальных имплантатов согласно международным стандартам.',
        tags: ['имплантация', 'хирургия', 'протокол'],
        updatedAt: '12.01.2024',
        views: 189
      },
      {
        id: 3,
        title: 'Протокол эндодонтического лечения',
        content: 'Современные стандарты лечения корневых каналов с использованием роторных инструментов и апекслокатора.',
        tags: ['эндодонтия', 'лечение', 'протокол'],
  ...
  },
  {
    id: 'equipment',
    name: 'Оборудование',
    description: 'Руководства по работе с оборудованием',
    icon: 'Settings',
    lastUpdated: '14.01.2024',
    articles: [
      {
        id: 4,
        title: 'Работа с интраоральным сканером',
        content: 'Инструкция по использованию 3D-сканера для получения цифровых слепков. Калибровка, сканирование, обработка данных.',
        tags: ['сканер', 'цифровая стоматология', 'оборудование'],
        updatedAt: '14.01.2024',
        views: 312
      },
      {
        id: 5,
        title: 'Эксплуатация микроскопа',
        content: 'Настройка и использование стоматологического микроскопа для эндодонтии и микрохирургии.',
        tags: ['микроскоп', 'оборудование', 'эндодонтия'],
  ...
  },
  {
    id: 'sales',
    name: 'Продажи',
    description: 'Техники продаж и работа с пациентами',
    icon: 'TrendingUp',
    ...
    articles: [
      {
        ...
        content: 'Применение методики СПИН (Ситуация, Проблема, Извлечение, Направляющие вопросы) в стоматологии для выявления потребностей.',
        tags: ['продажи', 'техники', 'консультация'],
        updatedAt: '16.01.2024',
        views: 423
      },
      {
        id: 7,
        title: 'Работа с возражениями о цене',
        content: 'Скрипты и техники ответов на типичные возражения пациентов относительно стоимости лечения.',
        tags: ['продажи', 'возражения', 'цена'],
  ...
  },
  {
    ...
    description: 'Работа администратора и клиентский сервис',
    icon: 'Users',
    lastUpdated: '15.01.2024',
    articles: [
      {
        id: 8,
        title: 'Скрипт телефонных переговоров',
        content: 'Готовые скрипты для записи пациентов по телефону, обработки входящих звонков и напоминаний о приеме.',
        tags: ['администратор', 'скрипты', 'телефон'],
        updatedAt: '15.01.2024',
        views: 278
      },
      {
        id: 9,
        title: 'Работа с конфликтными пациентами',
        content: 'Алгоритмы разрешения конфликтных ситуаций и техники деэскалации напряженности.',
        tags: ['администратор', 'конфликты', 'сервис'],
        updatedAt: '09.01.2024',
        views: 234
      }
    ]
  }
